...
`TabNpcf-HOD` is a fast HOD fitting pipeline using particle based tabulation method. Which support higher order statistic and multi-tracer fitting.
...
#### INI file comments for downsampling
...
#### INI file comments for paircounting
```bash
...
[[params]]
[[[logMcut/logM1/sigma/alpha...(hod parameters)]]]
